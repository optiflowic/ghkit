...
func (c Commenter) PrependGeneratedComment(content []byte, format f.Format, referenceUrl string) []byte {
	var notice string
	switch format {
	case f.Yaml, f.PlaneText:
		notice = fmt.Sprintf("### Generated by ghkit (%s)\n### %s\n\n", source_url.Repository, referenceUrl)
	case f.Markdown:
